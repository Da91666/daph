package com.dasea.daph.starter.jvm
...
object DaphJVMMain extends Logging {
  def main(args: Array[String]): Unit = {
    val cli = CliTool.extractInput(args)

    val logXml = cli.daphUserDefinedParameters.getOrElse("logXml", DAPH_HOME.default + "/conf/log/log4j2-jvm.xml")
